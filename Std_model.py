...
def run_std():
    ...
    for i in range(6):
        ...
        open('/home/meng/PyProject/Motor-life-prediction/std_model/std_model_'+str(i)+'.json','w').write(json_string) 
        model.save_weights('/home/meng/PyProject/Motor-life-prediction/std_model/std_model_'+str(i)+'.h5')
    figure_out(hists) 
